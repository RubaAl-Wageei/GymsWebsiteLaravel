...
<head>
	...
	<div id="booking" class="section" style="background-image: url({{ asset('/storage/Images/' . $gym->Image) }})";>
		<div class="section-center">
			<div class="container">
				<div class="row">
					<div class="col-md-4">
						<div class="booking-cta">
							<h1>Enjoy The Best Booking  At {{$gym->Name}} Salon</h1>
					...
					<div class="col-md-7 col-md-offset-1">
						<div class="booking-form">
							<form action="{{Route('UserGymBook.store')}}" method="post">
								@csrf
								<div class="row">
									<div class="col-md-6">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control" name="Gym_Services_Id" id="services"  value="{{ old('Gym_Services_Id')}}" class="@error('Gym_Services_Id') is-invalid @enderror">
												@foreach ($services as $value)

                                                <option value="{{$value->id}}">{{$value->ServiceName}}  price : {{$value->ServicePrice}} JD</option>
                                                @endforeach
											</select>
											@error('Gym_Services_Id')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
							...
							<br/>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="hidden" class="form-control bg-transparent" id="salon" placeholder="salon" name="GymName" value="{{ $gym->Name }}">
										</div>
									</div>
								...
								<div class="btn">
                                    ...
                                    <button class="submit-btn"><a href="GymUser" style="text-decoration-line: none;color:white">Cancle</a></button>
								</div>
								{{-- <div class="form-btn">
